...
router.post('/add', AuthMiddleware.validateToken, ReportMiddleware.validateData, ReportMiddleware.checkIfSessionExists, ReportMiddleware.checkIfUserCanReport, ReportMiddleware.updateSession, ReportController.addReport);
